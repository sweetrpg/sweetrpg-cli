...
"data":[{"id":"2","type":"OrderProduct","attributes":{"orderId":2,"productId":22,"royaltyPublisherId":0,"name":"Book Two","finalPrice":0,"quantity":1,"bundleId":0,"archived":0,"orderProductId":102,"customerId":0,"files":[],"filters":[],"history":[],"attributes":[]}}]}`
...
func TestFetchLibraryAggregatesAllPages(t *testing.T) {
	...
	if len(lib.Products) != 2 {
		t.Fatalf("got %d products, want 2", len(lib.Products))
	}
